...
**Status:** Partially complete | **Last Updated:** January 10, 2025
...
1. Discount rules: Apply before or after tax?
2. Invoice number format: Sequential? Include date?
3. Sale item identification: How to mark items as "sale" vs regular?
4. Business rule for $1000+ orders: Before or after tax threshold?
...
**Priority:** Fix critical bugs, get PDF working or have alternative solution
